...
import { GestionCajas } from './components/GestionCajas'; // ← NUEVA IMPORTACIÓN
    ...
    <BrowserRouter>
      <Routes>
        <Route element={<MainLayout />}>
          ...
          {/* CORREGIDO: path y element en orden correcto */}
          <Route
            path="/admin/cajas"
            element={
              <RutaProtegida usuario={usuario}>
